...
public class FixedRepeatingIntervalPattern extends RepeatingIntervalPattern {
    ...
    public Temporal adjustInto(Temporal temporal) {
        ...
        Duration timeSinceStart = Duration.between(interval.getStart(), date);
        ...
        long intervalDurationAsLong = interval.getDuration().get(unit);
        ...
        // otherwise,
            ...
            LocalDateTime timeOfNextOccurrence = interval.getStart().plus(Duration.of(timeSinceStartFromLastOccurrenceAsLong, unit));
